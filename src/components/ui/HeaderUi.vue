<template>
  <header
    class="sticky gap-2 flex flex-col lg:flex-row justify-between items-center border-b p-5 lg:p-10 lg:h-24 border-slate-300 w-full"
  >
    <div class="flex gap-5 items-center">
      <div :class="!authStore.token ? 'hidden lg:block': ''">
