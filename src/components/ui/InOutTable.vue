      ...
      <tbody class="text-secondary text-sm">
        ...
        >
          ...
          <td class="p-3 flex justify-center gap-2">
            <button class="bg-orange-400 text-white px-3 py-1 rounded-md text-xs hover:scale-105 transition">
              Edit
            </button>

            <button class="bg-red-600 text-white px-3 py-1 rounded-md text-xs hover:scale-105 transition">
              Delete
            </button>
          </td>
        </tr>
