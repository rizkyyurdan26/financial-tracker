<template>
  <div class="px-5 lg:mt-5">
    <!-- Title -->
    <h1
      class="text-2xl font-bold text-secondary flex items-end gap-1"
      data-sal="slide-up"
    ...
    <p class="text-secondary" data-sal="slide-up" data-sal-duration="2000">
    ...
    <div>
      ...
      <p v-if="store.error" class="text-red-500 text-center">
